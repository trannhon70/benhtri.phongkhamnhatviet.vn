...
$local = 'http://localhost/_nhatvietnew/benhtri.phongkhamnhatviet.vn';
// $local = 'https://benhtri.phongkhamnhatviet.vn'
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <script>
        ...
        document.addEventListener('scroll', function loadGA() {
            ...
            g.src = 'https://www.googletagmanager.com/gtag/js?id=G-WRDVKRY84S';
            g.async = true;
